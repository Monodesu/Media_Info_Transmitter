...
namespace Media_Info_To_VRChat_Discord
{
    public partial class settingsForm : Form
    {
        ...
        private void SettingsForm_Load(object sender, EventArgs e)
        {
            ...
            if (form1Instance.GlobalConfig.PriorityActionForMediaWithoutAlbum)
            {
        ...
        {
            form1Instance!.GlobalConfig.PriorityActionForMediaWithoutAlbum = true;
        }

        private void radioButton_SwitchToVideoAction1_CheckedChanged(object sender, EventArgs e)
        {
            form1Instance!.GlobalConfig.PriorityActionForMediaWithoutAlbum = false;
        }
